...
static const _PwmCmd_type_support_symbol_names_t _PwmCmd_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_maestro, msg, PwmCmd)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ros_maestro, msg, PwmCmd)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ros_maestro, msg, PwmCmd)() {
  return &::ros_maestro::msg::rosidl_typesupport_c::PwmCmd_message_type_support_handle;
}
