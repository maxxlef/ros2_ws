...
class Metaclass_PwmCmd(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('ros_maestro')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'ros_maestro.msg.PwmCmd')
            logger.debug(
    ...
    def pin(self, value):
        if __debug__:
            ...
            assert value >= -32768 and value < 32768, \
                "The 'pin' field must be an integer in [-32768, 32767]"
        self._pin = value
    ...
    def command(self, value):
        if __debug__:
            ...
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'command' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._command = value
