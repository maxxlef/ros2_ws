...
bool ros_maestro__msg__pwm_cmd__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros_maestro.msg._pwm_cmd.PwmCmd", full_classname_dest, 31) == 0);
  }
  ros_maestro__msg__PwmCmd * ros_message = _ros_message;
  {  // pin
    ...
    ros_message->pin = (int16_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // command
    ...
    ros_message->command = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * ros_maestro__msg__pwm_cmd__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros_maestro.msg._pwm_cmd");
